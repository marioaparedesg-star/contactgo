...
export const metadata = {
  ...
  description: 'Lentes ACUVUE® certificados en República Dominicana. OASYS, 1-DAY MOIST, Multifocal. Entrega 24-48h. Directo del fabricante.',
  alternates: { canonical: 'https://www.contactgo.net/marca/acuvue' },
  openGraph: {
    title: 'Lentes ACUVUE en RD | ContactGo',
    description: 'ContactGo — Tu destino para lentes ACUVUE® en República Dominicana. Originales. Rápidos. Garantizados.',
