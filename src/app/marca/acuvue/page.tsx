...
export const metadata = {
  ...
  description: 'Compra lentes de contacto ACUVUE originales en RD. Tienda especializada. Envío 24-48h a todo el país.',
  alternates: { canonical: 'https://www.contactgo.net/marca/acuvue' },
  openGraph: {
    title: 'Lentes ACUVUE en RD | ContactGo',
    description: 'Tienda especializada en lentes ACUVUE en República Dominicana.',
