        ...
        <div className="space-y-8 text-gray-700">
          ...
          <section className="bg-gray-50 border border-gray-200 rounded-2xl p-5">
            ...
            <div className="flex flex-col gap-1 text-sm">
              <span>📧 <MailLink className="text-primary-600 font-semibold">info@contactgo.net</MailLink></span>
              <span>📱 <a href="https://wa.me/18096942268" target="_blank" rel="noopener noreferrer" className="text-primary-600 font-semibold">(809) 694-2268</a></span>
