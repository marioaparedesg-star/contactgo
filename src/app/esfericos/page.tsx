    ...
    <>
      ...
      <main id="main-content" className="pb-20">
        ...
        <section className="max-w-3xl mx-auto px-4 py-10 space-y-4 text-gray-600 leading-relaxed border-t border-gray-100">
          ...
          <p>En ContactGo manejamos la selección más completa de lentes esféricos disponible en RD: desde los populares <strong>ACUVUE® 1-DAY MOIST®</strong> (diarios desechables) hasta los cómodos <strong>Biofinity®</strong> mensuales de CooperVision. todos son productos 100% originales con garantía de autenticidad.</p>
