...
const faqs = [
  ...
  { q: '¿Por qué tardan más en llegar los lentes tóricos?', a: 'Los lentes tóricos se fabrican a medida según tu graduación exacta (SPH, CYL y AXIS). Por eso el tiempo de entrega es de 20-30 días, en lugar de las 24-48 horas de los esféricos.' },
    ...
    <>
      ...
      <main id="main-content" className="pb-20">
        ...
        <section className="max-w-3xl mx-auto px-4 py-10 space-y-4 text-gray-600 leading-relaxed border-t border-gray-100">
          ...
          <p>Necesitas tu receta óptica completa con los valores <strong>SPH</strong> (esfera), <strong>CYL</strong> (cilindro) y <strong>AXIS</strong> (eje) para cada ojo. Usa nuestra <Link href="/receta" className="text-primary-600 font-semibold">calculadora de receta</Link> para verificar que estás eligiendo el lente correcto.</p>
        </section>
