...
export const metadata: Metadata = {
  ...
  description: 'Compra lentes de contacto con entrega a domicilio en Santo Domingo. ACUVUE, Biofinity, Air Optix directo del fabricante. Envío RD$200. Entrega en 24-48 horas.',
  ...
  openGraph: {
    ...
    description: 'Entrega a domicilio en Santo Domingo en 24-48h. Directo del fabricante.',
  ...
  return (
    <>
      ...
      <main id="main-content" className="pb-20">
        ...
        <section className="bg-gradient-to-br from-teal-600 via-teal-500 to-teal-600 text-white py-14 px-4 text-center mt-2">
          ...
          <p className="text-primary-100 text-lg max-w-xl mx-auto">Entrega a domicilio en toda el área metropolitana. ACUVUE, Biofinity, Air Optix y más — directo del fabricante.</p>
        ...
        <section className="max-w-3xl mx-auto px-4 py-10 space-y-4 text-gray-600 leading-relaxed border-t border-gray-100">
          ...
          <p>Todos nuestros productos son directo del fabricante, con garantía de autenticidad. El envío a Santo Domingo tiene un costo fijo de <strong>RD$200</strong> y es gratuito en pedidos superiores a RD$6,000.</p>
          ...
          <div className="space-y-3">
            <div className="bg-gray-50 rounded-2xl p-4 border-l-4 border-primary-500">
              <p className="text-gray-700 text-sm italic">"Excelente servicio, llegaron en 24 horas como prometieron. Los Acuvue son directo del fabricante, igual que en la óptica pero más baratos."</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
            {[['🚚','Envío RD$200'],['📦','Entrega 24-48h'],['✅','Directo del fabricante'],['↩️','Dev. 48 horas']].map(([i,t]) => (
