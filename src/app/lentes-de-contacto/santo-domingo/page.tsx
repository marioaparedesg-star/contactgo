...
export const metadata: Metadata = {
  title: 'Lentes de Contacto en Santo Domingo RD | Envío a Domicilio — ContactGo',
  description: 'Compra lentes de contacto con entrega en Santo Domingo. ACUVUE, Biofinity, Air Optix 100% originales. Envío rápido en República Dominicana.',
    ...
    <>
      ...
      <main id="main-content" className="pb-20">
        <section className="bg-gradient-to-br from-primary-700 to-teal-600 text-white py-16 px-4 text-center">
          ...
          <p className="text-primary-100 text-lg max-w-xl mx-auto">Entrega a domicilio en 24-48 horas en toda el área metropolitana. ACUVUE, Biofinity, Air Optix y más marcas originales.</p>
        ...
        <section className="max-w-3xl mx-auto px-4 py-12 space-y-4 text-gray-600 leading-relaxed">
          <h2 className="font-display text-2xl font-bold text-gray-900">La forma más fácil de conseguir lentes en Santo Domingo</h2>
