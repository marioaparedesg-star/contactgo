...
export const metadata: Metadata = {
  ...
  description: 'Compra lentes de contacto con entrega en Punta Cana. ACUVUE, Biofinity, Air Optix sellados de fábrica. Envío RD$350. Entrega en 48-72 horas.',
  ...
  openGraph: {
    ...
    description: 'Entrega a domicilio en Punta Cana en 48-72 horas. Sellados de fábrica.',
    ...
    <>
      ...
      <main id="main-content" className="pb-20">
        ...
        <section className="bg-gradient-to-br from-amber-600 via-primary-600 to-teal-600 text-white py-14 px-4 text-center mt-2">
          ...
          <p className="text-white/90 text-lg max-w-xl mx-auto">Entrega a domicilio en Punta Cana y toda la región. ACUVUE, Biofinity, Air Optix sellados de fábrica.</p>
        ...
        <section className="max-w-3xl mx-auto px-4 py-10 space-y-4 text-gray-600 leading-relaxed border-t border-gray-100">
          ...
          <p>Todos nuestros productos son sellados de fábrica y certificados por las marcas fabricantes. El envío a Punta Cana tiene un costo de <strong>RD$350</strong>, gratis en pedidos superiores a RD$6,000.</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
            {[['🚚','Envío RD$350'],['📦','48-72 horas'],['✅','Sellado de fábrica'],['↩️','Dev. 48 horas']].map(([i,t]) => (
