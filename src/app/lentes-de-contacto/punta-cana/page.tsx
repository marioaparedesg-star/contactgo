...
export const metadata: Metadata = {
  ...
  description: 'Compra lentes de contacto con entrega en Punta Cana. ACUVUE, Biofinity, Air Optix directo del fabricante. Envío RD$350. Entrega en 48-72 horas.',
  ...
  openGraph: {
    ...
    description: 'Entrega a domicilio en Punta Cana en 48-72 horas. Directo del fabricante.',
    ...
    <>
      ...
      <main id="main-content" className="pb-20">
        ...
        <section className="max-w-3xl mx-auto px-4 py-10 space-y-4 text-gray-600 leading-relaxed border-t border-gray-100">
          ...
          <p>Todos nuestros productos son directo del fabricante y certificados por las marcas fabricantes. El envío a Punta Cana tiene un costo de <strong>RD$350</strong>, gratis en pedidos superiores a RD$6,000.</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
            {[['🚚','Envío RD$350'],['📦','48-72 horas'],['✅','Directo del fabricante'],['↩️','Dev. 48 horas']].map(([i,t]) => (
