      ...
      <main>
        ...
        <section className="max-w-4xl mx-auto px-4 py-10 border-t border-gray-100">
          ...
          <div className="prose prose-gray max-w-none text-sm leading-relaxed space-y-4 text-gray-700">
            ...
            <p>Los precios de lentes de contacto en República Dominicana inician con entrega a domicilio para lentes diarios hasta RD$18,000 para lentes multifocales tóricos de alta graduación. Ofrecemos precios competitivos porque adquirimos directamente de los distribuidores oficiales en RD, sin intermediarios adicionales.</p>
          </div>
        </section>
