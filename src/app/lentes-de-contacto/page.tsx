      ...
      <main>
        ...
        <section className="max-w-4xl mx-auto px-4 py-10 border-t border-gray-100">
          ...
          <div className="prose prose-gray max-w-none text-sm leading-relaxed space-y-4 text-gray-700">
            ...
            <p>Para comprar lentes de contacto graduados necesitas una prescripción vigente (no mayor a 1 año). Puedes subir tu receta directamente en nuestra web o enviárnosla por WhatsApp al (829) 472-8328. Nuestro equipo de soporte verifica que los parámetros sean correctos antes de procesar tu pedido.</p>
