...
interface Props {
  searchParams: { tipo?: string; marca?: string; q?: string; min?: string; max?: string }
}
...
async function getMarcas(): Promise<string[]> {
  ...
  const marcas = [...new Set((data ?? []).map((d: any) => d.marca).filter(Boolean))]
  return marcas.sort()
}
              ...
              <div>
                ...
                <form method="GET" action="/catalogo">
                  <div className="relative">
                    ...
                    <input name="q" defaultValue={searchParams.q} placeholder="Nombre del producto..."
          ...
          <div className="flex-1">
            {products.length > 0 ? (
              ...
              <div className="card flex flex-col items-center justify-center py-20 text-center">
                ...
                <a href="/catalogo" className="mt-4 text-sm text-primary-600 font-semibold">
