  ...
  return (
    ...
    <main className="max-w-xl mx-auto px-4 py-12 pb-24">
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        <a href="https://wa.me/18096942268?text=Hola%20ContactGo%20%F0%9F%91%8B" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 border border-gray-100 rounded-2xl hover:border-green-200 hover:bg-green-50/20 transition-all">
