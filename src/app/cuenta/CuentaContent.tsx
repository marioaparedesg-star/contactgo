                  ...
                  {vencida && (
                    <div className="bg-red-50 border border-red-100 rounded-xl px-3 py-2.5 mb-3 flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <a href="/contacto?text=Hola%2C%20necesito%20información%20sobre%20revisión%20visual"
      ...
      {selectedPedido && (
        <div className="fixed inset-0 z-50 flex flex-col bg-gray-50">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-24">
            ...
            <a href={"/contacto?text=Hola%2C%20tengo%20una%20consulta%20sobre%20mi%20pedido%20%23"+selectedPedido.id.slice(-6).toUpperCase()}
              target="_blank"
