              ...
              <div className={`bg-white rounded-2xl border-2 transition-all duration-200 ${step === 3 ? 'border-primary-500 shadow-lg' : 'border-gray-100 opacity-50'}`}>
                ...
                {step === 3 && (
                  <div className="px-5 pb-6 border-t border-gray-100 pt-5 space-y-4">
                    ...
                    {/* Método de pago — tarjeta + contra entrega */}
                    <div className="space-y-2">
                      ...
                      {/* Contra entrega — segunda opción visible */}
                      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4">
                        <div className="flex items-start gap-3">
                          <span className="text-xl shrink-0">💵</span>
                          <div>
                            <p className="font-bold text-gray-800 text-sm">Pago contra entrega</p>
                            <p className="text-xs text-amber-700 mt-0.5">Paga en efectivo cuando recibas tu pedido. <strong>Sin riesgo.</strong></p>
                            <a
                              href={`https://wa.me/18294728328?text=${encodeURIComponent('Hola, quiero pagar mi pedido contra entrega en efectivo.')}`}
                            ...
                            >
                              ...
                              Solicitar pago contra entrega por WhatsApp →
                            </a>
                          </div>
                        </div>
                      </div>
