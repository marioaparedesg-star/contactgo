...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "¿Cuánto tarda en llegar mi pedido?", "acceptedAnswer": { "@type": "Answer", "text": "Santo Domingo: 24-48 horas. Santiago: 24-48 horas. Resto del país: 48-72 horas." } },
...
const SECCIONES = [
  {
    ...
    items: [
      { q: '¿Cuánto tarda en llegar mi pedido?', a: 'Santo Domingo: 24-48 horas. Santiago: 24-48 horas. Resto del país: 48-72 horas. Todos los pedidos se procesan de lunes a sábado. Excepción: lentes tóricos para astigmatismo (20-30 días, ver abajo).' },
      { q: '¿Por qué los lentes tóricos tardan más en llegar?', a: 'Los lentes tóricos (para astigmatismo) se fabrican a medida según la graduación exacta de cada paciente: Esfera (graduación principal), Cilindro y Eje. A diferencia de los lentes esféricos que tenemos en inventario, los tóricos requieren fabricación especial que toma entre 20 y 30 días calendario desde la confirmación del pedido. Te notificaremos por WhatsApp en cada etapa.' },
  ...
  },
  {
    ...
    items: [
      { q: '¿Son certificados los productos?', a: 'Todos nuestros productos son directo del fabricante, con garantía de autenticidad directamente de las marcas fabricantes.' },
  ...
  },
  {
    ...
    items: [
      { q: '¿Qué métodos de pago aceptan?', a: 'Tarjeta de crédito/débito Visa y Mastercard procesada por AZUL (Banco Popular) con 3D Secure. Seguro y rápido.' },
      { q: '¿Es seguro pagar con tarjeta?', a: 'Sí. Usamos tarjeta (Banco Popular), con encriptación SSL y verificación 3D Secure.' },
      { q: '¿Es seguro pagar con tarjeta?', a: 'Sí. Usamos AZUL de Banco Popular con tecnología 3D Secure. ContactGo nunca almacena datos de tarjetas.' },
    ],
  },
]
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 pb-24">
        ...
        <div className="mt-10 bg-green-50 border border-green-100 rounded-2xl p-6 text-center">
          ...
          <a href="https://wa.me/18096942268?text=Hola%20ContactGo%2C%20tengo%20una%20pregunta"
