...
const SECCIONES = [
  ...
  },
  {
    ...
    items: [
      { q: '¿Son certificados los productos?', a: 'Todos nuestros productos son sellados de fábrica, con garantía de autenticidad directamente de las marcas fabricantes.' },
