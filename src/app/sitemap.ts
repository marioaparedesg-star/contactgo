...
export default async function sitemap() {
  ...
  const staticUrls = [
    ...
    { url: 'https://contactgo.net/lentes-de-contacto/santo-domingo', priority: 0.85, changeFrequency: 'monthly' },
    ...
    { url: 'https://contactgo.net/referidos', priority: 0.7, changeFrequency: 'monthly' as const },
