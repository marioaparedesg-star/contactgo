                      ...
                      <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            {p.imagen_url ? <Image src={p.imagen_url} unoptimized width={32} height={32} className="w-8 h-8 rounded-lg object-cover" alt="" /> : <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center"><Eye className="w-3 h-3 text-gray-400" /></div>}
