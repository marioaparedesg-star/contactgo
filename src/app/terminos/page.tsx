  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 pb-24">
        ...
        {[
          { title: '1. Aceptación de los términos', body: 'Al acceder y usar ContactGo (contactgo.net), usted acepta estos Términos. ContactGo es una plataforma de comercio electrónico de lentes de contacto con operación en República Dominicana.' },
          ...
          { title: '8. Propiedad intelectual', body: 'Todo el contenido de ContactGo es propiedad de sus operadores. Queda prohibida su reproducción sin autorización escrita.' },
