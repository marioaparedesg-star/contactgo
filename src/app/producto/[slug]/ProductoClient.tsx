  ...
  if (ruta === 'no_tengo') {
    return (
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 space-y-2">
        ...
        <a href={`/contacto?text=${waMsg}`} target="_blank" rel="noopener"
  ...
  if (ruta === 'tengo') {
    return (
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 space-y-2">
        ...
        <a href={`/contacto?text=${waFoto}`} target="_blank" rel="noopener"
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="lg:hidden">
            ...
            <div className="px-4 pb-4 space-y-2">
              ...
              <a href={`/contacto?text=${encodeURIComponent(`Hola, quiero info sobre ${product.nombre}`)}`}
          ...
          <div className="hidden lg:grid lg:grid-cols-[400px_1fr_300px] xl:grid-cols-[440px_1fr_320px] gap-6 xl:gap-8 px-6 xl:px-8 py-6 items-start">
            ...
            <div className="space-y-4 min-w-0">
              ...
              <a href={`/contacto?text=${encodeURIComponent(`Hola, tengo una pregunta sobre ${product.nombre}.`)}`}
                target="_blank" rel="noopener"
              ...
              <div className="bg-white border-2 border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div className="p-3 space-y-2.5">
                  ...
                  <div className="border-t border-gray-100 pt-2.5">
                    ...
                    <a href={`/contacto?text=${encodeURIComponent(`Hola, quiero comprar ${product.nombre}. ¿Está disponible?`)}`}
                      target="_blank" rel="noopener"
