...
export default function Page() {
  return (<><Navbar /><main className="max-w-2xl mx-auto px-4 py-12 pb-24">
    ...
    <div className="space-y-8 text-gray-700 leading-relaxed">
      <p>ContactGo entrega lentes de contacto certificados directamente en tu hotel, residencia o negocio en Cap Cana en 24-48 horas. ACUVUE, Biofinity, Air Optix — sellados de fábrica y sellados de fabrica.</p>
      <section id="entrega">
