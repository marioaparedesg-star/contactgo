...
export const metadata: Metadata = {
  title: 'Lentes de contacto en Hato Mayor — Entrega a domicilio 2026 — ContactGo',
  description: 'Compra lentes de contacto con entrega en Hato Mayor, Hato Mayor. ACUVUE, Biofinity, Air Optix originales. Entrega 24-48h. Sin salir de casa. Pago con AZUL.',
  alternates: { canonical: 'https://www.contactgo.net/blog/lentes-contacto-hato-mayor' },
  openGraph: {
    type: 'article', title: 'Lentes de contacto en Hato Mayor — Entrega a tu puerta 2026',
    description: 'Compra lentes de contacto con entrega en Hato Mayor, Hato Mayor. ACUVUE, Biofinity, Air Optix originales. Entrega 24-48h. Sin salir de casa. Pago con AZUL.',
    url: 'https://www.contactgo.net/blog/lentes-contacto-hato-mayor',
    siteName: 'ContactGo', locale: 'es_DO',
    images: [{ url: 'https://www.contactgo.net/blog/lentes-contacto-entrega-rd.webp', width: 1200, height: 630, alt: 'Lentes de contacto en Hato Mayor — Entrega a tu puerta 2026' }],
  },
}
      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
          { "@context": "https://schema.org", "@type": "Article",
            "headline": "Lentes de contacto en Hato Mayor — Entrega a tu puerta 2026",
            "description": "Compra lentes de contacto con entrega en Hato Mayor, Hato Mayor. ACUVUE, Biofinity, Air Optix originales. Entrega 24-48h. Sin salir de casa. Pago con AZUL.",
            ...
            "url": "https://www.contactgo.net/blog/lentes-contacto-hato-mayor", "inLanguage": "es-DO",
            "about": { "@type": "Place", "name": "Hato Mayor", "addressCountry": "DO" } },
          { "@context": "https://schema.org", "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "¿Hacen entrega de lentes de contacto en Hato Mayor?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. ContactGo entrega lentes de contacto originales en Hato Mayor del Rey y alrededores en 24-48 horas. El proceso es 100% online y el pago con tarjeta a través de AZUL/Banco Popular." } },
              { "@type": "Question", "name": "¿Cuánto cuesta el envío a Hato Mayor?", "acceptedAnswer": { "@type": "Answer", "text": "El costo de envío a Hato Mayor se calcula al momento del checkout. Los pedidos superiores a RD$8,000 tienen envío gratuito. Consulta el costo exacto al agregar tu dirección de entrega." } },
              { "@type": "Question", "name": "¿Cuánto tarda la entrega en Hato Mayor?", "acceptedAnswer": { "@type": "Answer", "text": "La entrega en Hato Mayor es en 24-48 horas hábiles para la mayoría de los pedidos. Pedidos realizados antes de las 3pm salen el mismo día." } },
              { "@type": "Question", "name": "¿Qué marcas de lentes puedo comprar con entrega en Hato Mayor?", "acceptedAnswer": { "@type": "Answer", "text": "En ContactGo tienes acceso a más de 35 productos de ACUVUE, Air Optix, Biofinity, Bausch+Lomb, CooperVision y más, todos originales y sellados de fábrica." } }
            ] },
          { "@context": "https://schema.org", "@type": "BreadcrumbList",
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "Lentes en Hato Mayor", "item": "https://www.contactgo.net/blog/lentes-contacto-hato-mayor" }
            ] }
        ]) }} />
        ...
        <div className="flex items-center gap-1.5 text-xs text-gray-400 mb-4">
          ...
          <span className="text-gray-600">Lentes en Hato Mayor</span>
        </div>

        <span className="text-xs font-semibold text-primary-600 bg-primary-50 px-2 py-0.5 rounded-full">📍 Entrega en Hato Mayor</span>
        <h1 className="font-display text-3xl font-bold text-gray-900 mt-3 mb-2">Lentes de contacto en Hato Mayor — Entrega a tu puerta 2026</h1>

        <div className="flex items-center gap-3 mb-5 p-4 bg-green-50 border border-green-100 rounded-2xl">
          <span className="text-2xl">🚀</span>
          <div>
            <p className="text-sm font-bold text-green-800">Entrega 24-48h en Hato Mayor y Hato Mayor del Rey y alrededores</p>
            <p className="text-xs text-green-600">100% originales · Pago seguro con AZUL/Banco Popular</p>
          </div>
        </div>

        <div className="space-y-8 text-gray-700 leading-relaxed">
          <p>Comprar lentes de contacto en Hato Mayor nunca fue tan fácil. ContactGo entrega directamente en Hato Mayor del Rey y alrededores en 24-48 horas — sin necesidad de visitar ninguna tienda. Más de 35 productos de las marcas más reconocidas del mundo, 100% originales y sellados de fábrica.</p>

          <section>
            <h2 className="font-display text-xl font-bold text-gray-900 mb-4">Productos más vendidos disponibles en Hato Mayor</h2>
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900 mb-4">¿Cómo recibir lentes en Hato Mayor?</h2>
            <div className="space-y-3">
              {[
                { paso: '1', titulo: 'Elige tu lente en línea', desc: 'Busca por marca, tipo o graduación. Más de 35 productos disponibles.' },
                { paso: '2', titulo: 'Ingresa tu dirección en Hato Mayor', desc: 'Al hacer checkout, ingresa tu dirección exacta en Hato Mayor del Rey y alrededores.' },
          ...
          <section>
            <h2 className="font-display text-xl font-bold text-gray-900 mb-4">Preguntas frecuentes — Entrega en Hato Mayor</h2>
            <div className="space-y-3">
              {[
                { q: '¿Hacen entrega en Hato Mayor?', a: 'Sí. ContactGo entrega lentes de contacto originales en Hato Mayor del Rey y alrededores en 24-48 horas hábiles.' },
                ...
                { q: '¿Cuánto tarda la entrega en Hato Mayor?', a: 'Entre 24 y 48 horas hábiles para la mayoría de los pedidos. Pedidos antes de las 3pm suelen salir el mismo día.' },
        ...
        <div className="mt-10 bg-gradient-to-br from-primary-50 to-teal-50 border border-primary-100 rounded-2xl p-6 text-center">
          <h3 className="font-bold text-gray-900 text-lg mb-1">Recibe en Hato Mayor en 24-48h</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="https://wa.me/18295430580?text=Hola%2C%20quiero%20lentes%20con%20entrega%20en%20Hato%20Mayor" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#20ba58] transition-colors text-sm">Pedir por WhatsApp</a>
          </div>
        </div>
      </main>
      <Footer />
