    ...
    <>
            ...
            <ol className="space-y-2 text-sm list-none">
              {[
                ...
                <li key={i} className="flex items-start gap-2">
                  <span className="w-6 h-6 bg-teal-50 text-primary-700 rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">{i + 1}</span>
      ...
      "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient"},
        ...
        <div className="mt-10 bg-teal-50 border border-primary-100 rounded-2xl p-6 text-center">
          ...
          <a href="/catalogo?tipo=solucion" className="inline-flex items-center gap-2 bg-teal-500 text-white font-bold px-6 py-3 rounded-xl hover:bg-teal-600 transition-colors text-sm">
