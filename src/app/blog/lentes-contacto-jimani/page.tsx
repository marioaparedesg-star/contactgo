        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
          ...
          { "@context": "https://schema.org", "@type": "FAQPage",
            "mainEntity": [
              ...
              { "@type": "Question", "name": "¿Qué marcas de lentes puedo comprar con entrega en Jimaní?", "acceptedAnswer": { "@type": "Answer", "text": "En ContactGo tienes acceso a más de 35 productos de ACUVUE, Air Optix, Biofinity, Bausch+Lomb, CooperVision y más, todos certificados y directo del fabricante." } }
            ] },
