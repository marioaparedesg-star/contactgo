...
export default function Page() {
  return (<><Navbar /><main className="max-w-2xl mx-auto px-4 py-12 pb-24">
    ...
    <span className="text-xs font-semibold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full">📍 Entrega · Bavaro</span>
    <h1 className="font-display text-3xl font-bold text-gray-900 mt-3 mb-2">Lentes de contacto en Bavaro — Entrega a domicilio 24-48h</h1>
    ...
    <div className="space-y-8 text-gray-700 leading-relaxed">
      <p>ContactGo entrega lentes de contacto certificados directamente en tu hotel, residencia o negocio en Bavaro en 24-48 horas. ACUVUE, Biofinity, Air Optix — directo del fabricante y sellados de fabrica.</p>
      <section id="entrega">
        <h2 className="font-display text-2xl font-bold text-gray-900 mb-4">Zonas de entrega</h2>
        <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-4">
          <p className="font-bold text-gray-900 mb-2">Bavaro</p>
      ...
      <section id="como-pedir">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 p-3 border border-gray-100 rounded-xl"><div className="w-7 h-7 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xs font-black shrink-0">4</div><p className="text-sm text-gray-700">Recibe en Bavaro en 24-48 horas</p></div>
        </div>
