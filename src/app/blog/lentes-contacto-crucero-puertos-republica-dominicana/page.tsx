  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <span className="text-xs font-semibold text-primary-600 bg-teal-50 px-2 py-0.5 rounded-full">🚢 Pasajeros de crucero</span>
...
['antes-o-despues','Si te hospedas en RD antes o después del crucero']].map(([id, label]) => (
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <div className="grid gap-2">
            ...
            <a href="/blog/lentes-contacto-puerto-plata" className="border border-gray-100 rounded-xl p-3 hover:border-primary-200 hover:bg-teal-50/20 transition-all"><p className="text-sm font-semibold text-primary-600">→ Lentes de contacto en Puerto Plata</p><p className="text-xs text-gray-500 mt-0.5">Entrega en 24-48h</p></a>
            <a href="/blog/lentes-contacto-la-romana" className="border border-gray-100 rounded-xl p-3 hover:border-primary-200 hover:bg-teal-50/20 transition-all"><p className="text-sm font-semibold text-primary-600">→ Lentes de contacto en La Romana</p><p className="text-xs text-gray-500 mt-0.5">Entrega a domicilio</p></a>
