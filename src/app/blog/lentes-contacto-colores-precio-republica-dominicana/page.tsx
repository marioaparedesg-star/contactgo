      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <details className="group bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <p className="px-4 pb-4 text-gray-600 text-sm leading-relaxed">En ContactGo los Air Optix COLORS cuestan RD$2,625 la caja de 2 lentes (uso mensual) y los Lunare Tri-Kolor RD$2,250. Son los lentes de color más accesibles disponibles en RD con entrega a domicilio.</p>
          </details>
          <details className="group bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          ...
          <details className="group bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <p className="px-4 pb-4 text-gray-600 text-sm leading-relaxed">Los lentes de color certificados, usados correctamente, son seguros. El riesgo surge con lentes falsificados o de venta informal sin control de calidad. En ContactGo todos los lentes son directo del fabricante y certificados.</p>
          </details>
          <details className="group bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="mt-10 bg-gradient-to-br from-purple-50 to-teal-50 border border-purple-100 rounded-2xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">Directo del fabricante · Directo del fabricante · Pago seguro con AZUL · Entrega en toda República Dominicana</p>
