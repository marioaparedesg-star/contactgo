...
export const metadata: Metadata = {
  ...
  description: 'Compra lentes de contacto con entrega en Higüey, La Altagracia. ACUVUE, Biofinity, Air Optix certificados. Entrega 24-48h. Sin salir de casa. Pago con AZUL.',
  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <span className="text-xs font-semibold text-primary-600 bg-teal-50 px-2 py-0.5 rounded-full">📍 Entrega en Higüey</span>
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <p>Comprar lentes de contacto en Higüey nunca fue tan fácil. ContactGo entrega directamente en Higüey y toda la provincia de La Altagracia en 24-48 horas — sin necesidad de visitar ninguna tienda. Más de 30 productos de las marcas más reconocidas del mundo, directo del fabricante.</p>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                { q: '¿Hacen entrega en Higüey?', a: 'Sí. ContactGo entrega lentes de contacto en Higüey y toda la provincia de La Altagracia en 24-48 horas hábiles.' },
