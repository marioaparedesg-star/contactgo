    ...
    <>
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <div>
            ...
            {[
              ...
              { nombre: 'Biofinity® Multifocal', reemplazo: 'Mensual', precio: 'RD$3,650', add: '+1.00 a +2.50', desc: 'Diseño Balanced Progressive — zonas suaves de transición. Adaptación muy natural, especialmente para presbicia inicial.', href: '/producto/biofinity-multifocal-lentes-presbicia-coopervision-dominicana' },
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={s.semana} className="flex items-start gap-3 bg-gray-50 rounded-xl p-3">
                  <span className="text-xs font-bold bg-teal-50 text-primary-700 px-2 py-1 rounded-lg shrink-0">{s.semana}</span>
      ...
      "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient"},
        ...
        <div className="mt-10 bg-teal-50 border border-primary-100 rounded-2xl p-6 text-center">
          ...
          <a href="/multifocales" className="inline-flex items-center gap-2 bg-teal-500 text-white font-bold px-6 py-3 rounded-xl hover:bg-teal-600 transition-colors text-sm">
