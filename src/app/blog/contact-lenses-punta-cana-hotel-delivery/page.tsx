...
export default function Page() {
  return (<><Navbar /><main className="max-w-2xl mx-auto px-4 py-12 pb-24">
    ...
    <span className="text-xs font-semibold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full">📍 Delivery · Punta Cana</span>
    <h1 className="font-display text-3xl font-bold text-gray-900 mt-3 mb-2">Contact Lenses Delivery to Punta Cana Hotels — Same Day</h1>
    ...
    <div className="space-y-8 text-gray-700 leading-relaxed">
      <p>ContactGo delivers original contact lenses directly to your hotel or home in Punta Cana within 24-48 hours. ACUVUE, Biofinity, Air Optix — all directo del fabricante, direct from manufacturer.</p>
      <section id="entrega">
        <h2 className="font-display text-2xl font-bold text-gray-900 mb-4">Delivery zones</h2>
        <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-4">
          <p className="font-bold text-gray-900 mb-2">Punta Cana</p>
      ...
      <section id="como-pedir">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 p-3 border border-gray-100 rounded-xl"><div className="w-7 h-7 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xs font-black shrink-0">4</div><p className="text-sm text-gray-700">Receive in Punta Cana in 24-48 hours</p></div>
        </div>
