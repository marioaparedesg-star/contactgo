        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3">
              ...
              <a href="https://wa.me/18096942268?text=Hola%2C%20quiero%20comprar%20ACUVUE%20Oasys%20en%20Rep%C3%BAblica%20Dominicana" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold px-5 py-3 rounded-xl hover:bg-[#20ba58] transition-colors text-sm">
                Pedir por WhatsApp
              </a>
            </div>
          </section>
