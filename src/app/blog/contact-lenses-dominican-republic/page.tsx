      ...
      <Navbar /><main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <section id="how-it-works">
          ...
          <div className="space-y-3">
            {[
              { step: '1', title: 'Browse our catalog', desc: 'We carry ACUVUE (Johnson & Johnson), Air Optix (Alcon), Biofinity (CooperVision), Bausch+Lomb and more — all sellado de fábrica, factory sealed.' },
        ...
        <section id="delivery">
          ...
          <section id="faq"><h2 className="font-display text-2xl font-bold text-gray-900 mb-5">Preguntas frecuentes</h2>
            <div className="space-y-3">          <details className="group bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden"><summary className="flex items-center justify-between p-4 cursor-pointer font-semibold text-gray-900 text-sm list-none">Can I buy contact lenses in the Dominican Republic?<svg className="w-4 h-4 text-gray-400 group-open:rotate-180 transition-transform shrink-0 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/></svg></summary><p className="px-4 pb-4 text-gray-600 text-sm leading-relaxed">Yes. ContactGo is the only specialized online contact lens store in the DR, offering sellado de fábrica lenses (ACUVUE, Biofinity, Air Optix, Bausch+Lomb) with delivery to hotels and homes throughout the country in 24-48 hours.</p></details>
