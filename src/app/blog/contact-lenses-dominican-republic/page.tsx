...
export const metadata: Metadata = {
  title: 'Contact Lenses in Dominican Republic — Same Day Delivery | ContactGo', description: 'Buy contact lenses in the Dominican Republic with same-day delivery in Santo Domingo and Punta Cana. ACUVUE, Biofinity, Air Optix originals. Secure payment. Fast shipping.',
  alternates: { canonical: 'https://www.contactgo.net/blog/contact-lenses-dominican-republic' },
  openGraph: { type: 'article', title: 'Contact Lenses in the Dominican Republic — Fast Delivery to Your Hotel', description: 'Buy contact lenses in the Dominican Republic with same-day delivery in Santo Domingo and Punta Cana. ACUVUE, Biofinity, Air Optix originals. Secure payment. Fast shipping.', url: 'https://www.contactgo.net/blog/contact-lenses-dominican-republic', siteName: 'ContactGo', locale: 'es_DO', images: [{ url: 'https://www.contactgo.net/blog/contact-lenses-dominican-republic.webp', width: 1200, height: 630, alt: 'Contact Lenses in the Dominican Republic — Fast Delivery to Your Hotel' }] },
}
      ...
      <Navbar /><main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <section id="how-it-works">
          ...
          <div className="space-y-3">
            {[
              { step: '1', title: 'Browse our catalog', desc: 'We carry ACUVUE (Johnson & Johnson), Air Optix (Alcon), Biofinity (CooperVision), Bausch+Lomb and more — all 100% original, factory sealed.' },
