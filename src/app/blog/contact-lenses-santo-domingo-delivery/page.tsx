...
export default function Page() {
  return (<><Navbar /><main className="max-w-2xl mx-auto px-4 py-12 pb-24">
    ...
    <div className="space-y-8 text-gray-700 leading-relaxed">
      <p>ContactGo delivers original contact lenses directly to your hotel or home in Santo Domingo within 24-48 hours. ACUVUE, Biofinity, Air Optix — all sellado de fábrica, factory sealed.</p>
      <section id="entrega">
