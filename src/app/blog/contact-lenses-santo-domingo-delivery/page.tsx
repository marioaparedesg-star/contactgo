...
export default function Page() {
  return (<><Navbar /><main className="max-w-2xl mx-auto px-4 py-12 pb-24">
    ...
    <div className="space-y-8 text-gray-700 leading-relaxed">
      <p>ContactGo delivers original contact lenses directly to your hotel or home in Santo Domingo within 24-48 hours. ACUVUE, Biofinity, Air Optix — all 100% original, factory sealed.</p>
      <section id="entrega">
      ...
      <section id="como-pedir">
        ...
        <div className="mt-4 bg-green-50 border border-green-200 rounded-xl p-4">
          ...
          <a href="https://wa.me/18294728328" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25D366] text-white font-bold px-5 py-2.5 rounded-xl text-sm hover:bg-[#20ba58] transition-colors">Order on WhatsApp →</a>
        </div>
      </section>
      <section id="faq">
        <h2 className="font-display text-2xl font-bold text-gray-900 mb-5">Frequently asked questions</h2>
        <div className="space-y-3">
          <details className="group bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden"><summary className="flex items-center justify-between p-4 cursor-pointer font-semibold text-gray-900 text-sm list-none">Do you deliver contact lenses in Santo Domingo?<svg className="w-4 h-4 text-gray-400 group-open:rotate-180 transition-transform shrink-0 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/></svg></summary><p className="px-4 pb-4 text-gray-600 text-sm leading-relaxed">Yes. ContactGo delivers ACUVUE, Biofinity and Air Optix originals to Santo Domingo and surrounding areas in 24-48 hours. Secure payment with Visa or Mastercard.</p></details>
    ...
    <div className="mt-10 bg-gradient-to-br from-primary-50 to-teal-50 border border-primary-100 rounded-2xl p-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a href="https://wa.me/18294728328" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#20ba58] transition-colors text-sm">Order on WhatsApp</a>
      </div>
    </div>
  </main><Footer /></>)
}
