    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <p>Comprar lentes de contacto en Baní nunca fue tan fácil. ContactGo entrega directamente en Baní y toda la provincia de Peravia en 24-48 horas — sin necesidad de visitar ninguna tienda. Más de 30 productos de las marcas más reconocidas del mundo, directo del fabricante.</p>
