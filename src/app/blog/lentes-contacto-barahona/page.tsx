    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
          ...
          { "@context": "https://schema.org", "@type": "FAQPage",
            "mainEntity": [
              ...
              { "@type": "Question", "name": "¿Qué marcas de lentes puedo comprar con entrega en Barahona?", "acceptedAnswer": { "@type": "Answer", "text": "En ContactGo tienes acceso a más de 35 productos de ACUVUE, Air Optix, Biofinity, Bausch+Lomb, CooperVision y más, todos certificados y directo del fabricante." } }
            ] },
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <p>Comprar lentes de contacto en Barahona nunca fue tan fácil. ContactGo entrega directamente en Barahona y la costa sur en 24-48 horas — sin necesidad de visitar ninguna tienda. Más de 35 productos de las marcas más reconocidas del mundo, directo del fabricante.</p>
