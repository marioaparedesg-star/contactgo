...
export const metadata: Metadata = {
  ...
  description: 'Compra lentes de contacto con entrega en Dajabón, Dajabón. ACUVUE, Biofinity, Air Optix certificados. Entrega 24-48h. Sin salir de casa. Pago con AZUL.',
      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
          ...
          { "@context": "https://schema.org", "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "¿Hacen entrega de lentes de contacto en Dajabón?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. ContactGo entrega lentes de contacto en Dajabón y la frontera norte en 24-48 horas. El proceso es 100% online y el pago con tarjeta a través de AZUL/Banco Popular." } },
              ...
              { "@type": "Question", "name": "¿Qué marcas de lentes puedo comprar con entrega en Dajabón?", "acceptedAnswer": { "@type": "Answer", "text": "En ContactGo tienes acceso a más de 35 productos de ACUVUE, Air Optix, Biofinity, Bausch+Lomb, CooperVision y más, todos certificados y sellados de fábrica." } }
            ] },
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <p>Comprar lentes de contacto en Dajabón nunca fue tan fácil. ContactGo entrega directamente en Dajabón y la frontera norte en 24-48 horas — sin necesidad de visitar ninguna tienda. Más de 35 productos de las marcas más reconocidas del mundo, sellados de fábrica y sellados de fábrica.</p>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                { q: '¿Hacen entrega en Dajabón?', a: 'Sí. ContactGo entrega lentes de contacto en Dajabón y la frontera norte en 24-48 horas hábiles.' },
