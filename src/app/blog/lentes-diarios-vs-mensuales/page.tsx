    ...
    <>
      ...
      <main className="max-w-2xl mx-auto px-4 py-12 pb-24">
        ...
        <div className="mt-10 bg-gradient-to-br from-primary-50 to-teal-50 border border-primary-100 rounded-2xl p-6 text-center">
          ...
          <p className="text-xs text-gray-400 mb-4">100% originales · Pago seguro AZUL · Sin complicaciones</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="https://wa.me/18295430580?text=Hola%2C%20no%20s%C3%A9%20si%20elegir%20lentes%20diarios%20o%20mensuales%2C%20%C2%BFme%20asesoran%3F" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#20ba58] transition-colors text-sm">
              Asesoría WhatsApp
            </a>
          </div>
        </div>
