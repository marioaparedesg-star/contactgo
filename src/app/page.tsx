...
export const metadata: Metadata = {
  title: 'ContactGo — Lentes de contacto certificados en RD | Entrega 24h',
  description: 'ContactGo — La única tienda dominicana especializada 100% en lentes de contacto. ACUVUE, Air Optix, Biofinity certificados. Recibe en 24-48h. Compra en minutos.',
...
async function getFeaturedProducts(): Promise<{ products: Product[], reseñasCount: number, reseñasAvg: number, precioOasys: number, preciosHero: Record<string, number> }> {
  ...
  return {
    ...
    reseñasAvg,
    precioOasys: oasysData ? Number(oasysData.precio) : 3350,
    preciosHero,
  }
}
          ...
          <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="flex-1 grid grid-cols-2 gap-3 w-full max-w-sm">
                {[
                  { brand: 'ACUVUE®', logo: 'https://atendbjolicwcsqfyiyh.supabase.co/storage/v1/object/public/products/acuvue_logo.jpg', href: '/marca/acuvue' },
                  { brand: 'AIR OPTIX®', logo: 'https://atendbjolicwcsqfyiyh.supabase.co/storage/v1/object/public/products/alcon_logo.jpg', href: '/marca/alcon' },
                  { brand: 'CooperVision®', logo: 'https://atendbjolicwcsqfyiyh.supabase.co/storage/v1/object/public/products/coopervision_logo.jpg', href: '/marca/coopervision' },
                  { brand: 'Bausch+Lomb', logo: 'https://atendbjolicwcsqfyiyh.supabase.co/storage/v1/object/public/products/bauschlomb_logo.jpg', href: '/catalogo' },
                ].map(m => (
                  <a key={m.brand} href={m.href}
                    className="bg-white border border-gray-200 rounded-2xl p-4 text-center block hover:shadow-md hover:scale-[1.02] transition-all cursor-pointer">
                    <div className="relative w-full h-10 mb-2">
                      <Image src={m.logo} alt={m.brand} fill className="object-contain" unoptimized />
                    </div>
