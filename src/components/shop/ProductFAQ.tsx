...
const FAQS_GENERAL = [
  ...
  { q: '¿Los productos son 100% originales?', a: 'Sí. Todos nuestros productos son 100% originales, adquiridos de revendedor especializado. Compramos directamente a los distribuidores oficiales — Optimax SRL y Kettle Sánchez & Co. — garantizando autenticidad en cada producto.' },
