    ...
    <div className="space-y-2.5">
      ...
      {s.mismaReceta === false && !s.noEstaSeguro && (
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 text-xs text-blue-700 flex items-start gap-2">
          ...
          <span>Perfecto — ingresa la graduación de cada ojo por separado. Si no tienes tu receta a mano, <a href="/contacto?text=Hola%2C+necesito+ayuda+con+mi+receta+para+lentes+de+color" target="_blank" rel="noopener noreferrer" className="font-bold underline">escríbenos por WhatsApp</a> y te ayudamos.</span>
        </div>
      )}
    </div>
  ) : null
  ...
  if (s.ojoMode === 'AMBOS' && s.noEstaSeguro) return (
    <div className="space-y-5">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 space-y-3">
        ...
        <a href="/contacto?text=Hola%2C%20necesito%20ayuda%20con%20mi%20receta%20de%20lentes%20de%20contacto" onClick={() => trackWhatsappHelp('no_seguro')}
