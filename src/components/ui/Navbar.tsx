    ...
    <header className={`sticky top-0 z-50 bg-white border-b border-gray-100 transition-shadow duration-200 ${scrolled ? "shadow-md" : "shadow-sm"}`} role="banner">
      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center relative" aria-label="ContactGo — Ir al inicio">
          <NextImage src="/logo.png" alt="ContactGo" width={200} height={33} className="h-8 sm:h-10 w-auto object-contain" priority />
        ...
        <div className="flex items-center gap-2" role="navigation" aria-label="Acciones de usuario">
          ...
          <a href="https://wa.me/18096942268?text=Hola%20ContactGo%20%F0%9F%91%8B"
            target="_blank" rel="noopener noreferrer"
            onClick={() => trackWhatsappHelp('navbar')}
