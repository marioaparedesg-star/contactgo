...
export const BLOG_SLUGS: string[] = [
  ...
  "air-optix-vs-bausch-lomb-ultra-comparacion-rd",
  ...
  "avaira-vitality-vs-bausch-lomb-ultra-comparacion-rd",
  ...
  "clariti-vs-biofinity-diario-vs-mensual-rd",
  ...
  "como-leer-tu-receta",
  "como-limpiar-cambiar-estuche-lentes-de-contacto",
  "como-poner-lentes-de-contacto",
  "como-saber-mi-talla-curvatura-diametro-lentes-contacto-rd",
  "como-saber-si-lente-contacto-esta-al-reves",
  ...
  "emergency-contact-lenses-dominican-republic-forgot-prescription",
  ...
  "how-much-do-contact-lenses-cost-dominican-republic",
  ...
  "lentes-contacto-adultos-mayores-60-rd",
  "lentes-contacto-alergia-conjuntivitis",
  "lentes-contacto-alquiler-airbnb-turistas-rd",
  ...
  "lentes-contacto-boda-novia-maquillaje-rd",
  "lentes-contacto-bonao",
  "lentes-contacto-buceo-snorkel-agua-mar-rd",
  "lentes-contacto-cambio-clima-humedad-vs-seco-rd",
  "lentes-contacto-cap-cana-entrega",
  "lentes-contacto-carnaval-antifaz-disfraz-rd",
  "lentes-contacto-chef-cocina-vapor-calor-rd",
  "lentes-contacto-ciclismo-bicicleta-rd",
  ...
  "lentes-contacto-estudiantes-universidad-examenes-rd",
  ...
  "lentes-contacto-pesca-deportiva-rd",
  ...
  "lentes-contacto-reciclaje-empaque-ambiental-rd",
  "lentes-contacto-rgp-rigidos-permeables-gas-rd",
  "lentes-contacto-salcedo-hermanas-mirabal",
  "lentes-contacto-salon-belleza-estilistas-rd",
  ...
  "lentes-contacto-tenis-pickleball-rd",
  "lentes-contacto-toda-republica-dominicana",
  "lentes-contacto-trabajo-remoto-videollamadas-rd",
  "lentes-contacto-uniforme-trabajo-profesiones-rd",
  ...
  "lentes-contacto-yoga-pilates-rd",
  ...
  "miopia-vs-astigmatismo-diferencia-explicada-simple",
  ...
  "proclear-vs-air-optix-comparacion-rd",
  ...
  "receta-vencida-vs-graduacion-cambiada-diferencia-rd",
